...
https://mateo-m.github.io/kotoba/essential/installation

| File | Use when |
| --- | --- |
| `essentials_smoke_test.rb` | Essentials ZIP — boot + test message |
| `bare_rgss_smoke_test.rb` | `kotoba-bare-rgss.zip` — boot + test message |
