...
Fangame with `Game.exe`? Use [Installing in a game](/v0.1.0/essential/installation) instead.
...
Catalogs are strict JSON. Leaves must be strings. Lookup keys join nested names with dots. See [Catalog format](/v0.1.0/essential/catalog-format).
...
Plain RGSS: [Bare RGSS](/v0.1.0/integration/bare-rgss). Essentials: [Pokemon Essentials](/v0.1.0/integration/pokemon-essentials). Custom kit: [Third-party adapters](/v0.1.0/integration/third-party).
