---
title: Tolgee
description: Export and import catalogs for Tolgee.
---
...
```sh
bin/ruby18 bin/kotoba flat-export Locales/en.json build/tolgee.en.json
```

Import:

```sh
bin/ruby18 bin/kotoba flat-import build/tolgee.fr.json Locales/fr.json
```
