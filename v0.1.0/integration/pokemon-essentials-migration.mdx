...
1. Install the matching Essentials adapter from a [release integration ZIP](/v0.1.0/essential/installation).
...
Import commands use `bin/ruby18 bin/kotoba` from a cloned repo ([Validation CLI](/v0.1.0/tooling/validation-cli)), not inside RPG Maker.
