...
Clone this repo on a PC to run export/import commands ([Tooling](/v0.1.0/tooling/)). Copy finished `Locales/*.json` into the game folder beside `Game.exe`.

Send translators [For translators](/v0.1.0/translators/) and [Placeholders](/v0.1.0/translators/placeholders) with the CSV.
