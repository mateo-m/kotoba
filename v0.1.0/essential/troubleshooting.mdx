...
Install walkthrough: [Installing in a game](/v0.1.0/essential/installation).
...
Fix: [Pokemon Essentials](/v0.1.0/integration/pokemon-essentials) or [Essentials migration](/v0.1.0/integration/pokemon-essentials-migration).
...
[Validation CLI](/v0.1.0/tooling/validation-cli). Returned spreadsheets may drop placeholders or `\c[n]` codes. Send translators [Placeholders](/v0.1.0/translators/placeholders).
