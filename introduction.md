---
title: Introduction
description: What Kotoba is, a small catalog example, and which page to open next.
sidebar:
  icon: book-open
  order: 2
---

You are reading the **latest** Kotoba guide. For a released library version, pick it in the version switcher in the header.
